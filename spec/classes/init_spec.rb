...
")
    ...
    context 'with ensure_vas=present on osfamily Solaris with kernelrelease 5.9' do
      let(:params) { { :ensure_vas => 'present' } }
      let :facts do
        {
          :osfamily      => 'Solaris',
...
# Password
login   password required        pam_dhkeys.so.1
...
# Session
login   session  required        pam_vas3.so create_homedir
